...
class ClassificationDataset(Dataset):
    def __init__(self,
        ...
        if len(self.input_dims) == 3:
            if self.input_dims[2] == 3: # Three channel RGB images
    ...
    def split_train_vad(self, batch_size, split=[0.75], num_workers=0):
        indices = list(range(self.n_data))
        ...
        if self.seed is None:
            ...
            train_indices, val_indices = indices[:int(split[0] * self.n_data)], \
